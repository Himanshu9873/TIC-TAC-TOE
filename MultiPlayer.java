...
class MultiPlayer extends JFrame 
{
	 int k=0,l=0,count=0;
	JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b,b10;
	JTextField tf;
	MultiPlayer()
	{
		super();
	 tf=new JTextField();
	 tf.setBounds(20,370,270,30);
	 tf.setEditable(false);
	 b=new JButton("Start New Game");
	 b.setBounds(40,320,130,30);
	 b1=new JButton("");
...
public int check()
{
	...
	else
	{
	  ...
	  return 3;
		...
		{
		 MultiPlayer jf=new MultiPlayer();
